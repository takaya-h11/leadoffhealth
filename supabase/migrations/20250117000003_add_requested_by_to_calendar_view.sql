-- ============================================================================
-- calendar_slots_for_usersビューにrequested_byを追加
-- ============================================================================
-- 目的: 自分が予約した予約、自社の他人が予約した予約、他社の予約を区別するため
-- ============================================================================
...
SELECT
  ...
  a.requested_by,  -- 予約申込者のuser_id（自分の予約判定用）
...
COMMENT ON VIEW public.calendar_slots_for_users IS '利用者向けカレンダービュー（他社の個人情報は非表示、requested_byで自分の予約を判定可能）';
